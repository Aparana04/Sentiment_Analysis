...
text = open('reviews.txt', mode='r',encoding='utf-8').read()
...
def create_app_ui():
         ...
         dbc.Jumbotron(
             ...
             html.Img(src = app.get_asset_url('j.jpg'))
                  ...
                  ,}),
                    ...
                    html.Div([html.H1(children='Pie Chart', id='pieh1',style={'padding':2})]),
    ...
    ], className="row",style={'padding-left': '50px', 'padding-right': '50px','text-align':'center','font-weight': 'bold'}),
    html.Hr(),
